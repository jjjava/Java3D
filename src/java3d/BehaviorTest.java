...
/**
 * Creates five sample behaviors and applies them to an object in a scene: <p>
 ...
 */
public class BehaviorTest extends Java3dApplet2 implements ExplosionListener,
        ActionListener {
            ...
            if (wakeUp instanceof WakeupOnElapsedFrames) {
                if (m_TransformGroup != null) {
                    ...
                    if (bounds instanceof BoundingSphere) {
                        ...
                        System.err.println("BoundsBehavior found a Bounds it cannot represent: "
                                + bounds);
                    }
    ...
    public void processStimulus(java.util.Enumeration criteria) {
        while (criteria.hasMoreElements()) {
            ...
            if (wakeUp instanceof WakeupOnElapsedTime) {
                ...
                m_TransparencyAttributes.setTransparency(((float) m_nFrameNumber)
                        / ((float) m_nNumFrames));
                m_Shape3D.getAppearance().setTransparencyAttributes(
                        m_TransparencyAttributes);
 ...
 */
//*****************************************************************************
abstract class Java3dApplet2 extends Applet {
